...
hunter_config(Android-SDK VERSION 0.0.4)
...
hunter_config(Armadillo VERSION 7.800.2)
...
hunter_config(Boost VERSION 1.63.0)
...
hunter_config(Eigen VERSION 3.3.3-p0)
...
hunter_config(Catch VERSION 1.5.9)
...
hunter_config(ceres-solver VERSION 1.12.0-p0)
...
hunter_config(doctest VERSION 1.1.4-hunter-1)
...
hunter_config(gflags VERSION 2.1.2-p1)
...
hunter_config(ogles_gpgpu VERSION 0.1.6-p2)
